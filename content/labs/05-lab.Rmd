...
You can either download the lab as an RMarkdown file <a href="../../lab-handouts/05-lab.Rmd" download="05-lab.Rmd">here</a>, or copy and paste the code as we go into a `.R` script. Either way, save it into the `05-week` folder where you completed the exercises!
