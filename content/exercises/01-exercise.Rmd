...
![](../../slides/img/rstudio-download.png)
...
![](../../slides/img/workspace-option.png)
...
Click [here](/exercises/01-week.zip) to download this week's files. You'll have to unzip it to access the files inside. This is a little annoying if you are on Windows, but you can follow these instructions:

### Unzip a folder in Windows {-}

1. Save the zip file to Downloads. You should see something like this:

![](../../slides/img/save-download.png)

2. Go up to `Extract -> Compressed Folder Tools -> Extract All`, like this:

![](../../slides/img/extract.png)

3. Just leave the default folder for extraction. We'll move it later.

![](../../slides/img/unzip.png)
...
![](../../slides/img/Rproj-open-windows.png)
...
![](../../slides/img/working-directory.png)
